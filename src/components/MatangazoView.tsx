      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
            <h3 className="font-display font-black text-slate-950 dark:text-white text-base uppercase tracking-tight flex items-center gap-2">
              <Megaphone className="text-cyan-600 animate-pulse" size={18} />
              Habari &amp; Matukio ya Kielimu ({announcements.length})
            </h3>
            <span className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest bg-slate-100 dark:bg-slate-900 px-2 py-1 rounded-lg">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16 gap-3 text-cyan-600">
              ...
              <p className="text-xs font-black uppercase tracking-widest animate-pulse">Inapakua Matangazo ya Hivi Karibuni...</p>
            </div>
          ) : (
            <motion.div 
              initial="hidden"
            ...
            >
              {announcements.map((ann, i) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-slate-950 border-2 border-slate-150 dark:border-slate-900 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all relative overflow-hidden group"
                >
                  ...
                  <div className="flex justify-end mt-4 border-t border-slate-100 dark:border-slate-900 pt-3">
                    <button 
                      ...
                      className="text-[10px] font-black uppercase tracking-wider text-slate-400 hover:text-cyan-500 flex items-center gap-1"
                    >
                      <Share2 size={12} />
                      Sambaza Habari
                    </button>
